...
class FedAvg(Strategy):
    ...
    def aggregate_fit(
        ...
        Path("logs_NOdinamico").mkdir(exist_ok=True)

        
        log(INFO, f"[ROUND {server_round}] Nessun limite di tempo applicato.")
        ...
        for client, fit_res in results:
                ...
                if client_elapsed_time is not None:
                    ...
                    with open("logs_NOdinamico/response_times_nosoglia.csv", "a", newline="") as csvfile:
